...
`numericRange`::
The `numericRange` property indicates that the numerical value of the field must be in a specific range.
+
[source,json]
----
"numericRange" : {
...
----
<1> The value of this field must be greater than or equal to the indicated value. If omitted there is no lower limit to the range.
<2> The value of this field must be lower than or equal to the indicated value. If omitted there is no upper limit to the range.
