...
`attributeOf`:: If the field is an XML attribute this indicates the identifier of the field (element) which has the attribute.
`attributeName`:: The name of the XML attribute.
`attributes`:: An array of one or more field identifiers representing the attributes this field can have.
