...
to contain empty elements or attributes. So if a field is not mandatory and no value has been filled it, then the corresponding XML element must be omitted from the XML notice.
