...
For a given lot, winners are tenderers members of Tendering Parties for which the tender:

* Was submitted for that lot, and

* Has been selected as part of the winning tenders (Tenders associated to a contract, 
i.e. tender for which there exists a BT-3202-Contract whose value equals the one of 
its OPT-321-Tender field.).
...
. Extract, from these Tenders, the ones referenced in a contract,

. Identify the associated Tendering Party, and

. From there identify each Tenderer belonging to the Tendering Party.
...
identify the tender and check this is a winning one.
