...
|BT-1501(p) |Modification Previous Notice Section Identifier |BT-1501(p)-Contract a|
...
|OPP-090 |Previous Notice |OPP-090-Procedure |Publication ID of the previous (TED XML) notice.
