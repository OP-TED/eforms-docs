...
Cross Border legislation may be indicated as specified in https://docs.ted.europa.eu/eforms/latest/schema/procedure-lot-part-information.html#crossBorderLawSection[Cross Border Law (Procedure) (BT-09)].
