...
is set to 'true'), then Selection Criteria code (BT-809-Lot) and Selection Criteria Description 
...
and further details on Exclusion Grounds may and has to be provided in the notice when the "notice" 
is identified as a source for exclusion grounds.
