...
----
    ...
    <efac:SelectionCriteria>
        <cbc:CriterionTypeCode listName="selection-criterion">slc-stand-to-avg</cbc:CriterionTypeCode>
    ...
    <efac:SelectionCriteria>
        <cbc:CriterionTypeCode listName="selection-criterion">slc-abil-facil-res</cbc:CriterionTypeCode>
