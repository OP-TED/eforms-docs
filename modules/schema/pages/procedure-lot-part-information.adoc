...
|*Selection Criteria (BT-809)* |xref:selectionCriteriaSection[xrefstyle=short] |-- |-- |*?* |-- |-- |*?* |-- |-- 
a|
[source,xpath,subs=attributes]
----
...
|*Exclusion Grounds Source (BT-806)* | xref:exclusionGroundsSourceSection[xrefstyle=short] h|* |-- |-- |-- |-- |-- |-- |--
a|
[source,xpath,subs=attributes]
----
...
|*Exclusion Grounds (BT-67(a))* | xref:exclusionGrounds[xrefstyle=short] h|? |-- |-- |-- |-- |-- |-- |-- a|
[source,xpath,subs=attributes]
----
...
|*Exclusion Grounds Description (BT-67(b))* | xref:exclusionGrounds[xrefstyle=short] h|? |-- |-- |-- |-- |-- |-- |-- a|
[source,xpath,subs=attributes]
----
...
codelistfootnote:[For criteria that would not fit into the predefined list, the value "other" is also available.].
...
is set to 'epo-Notice'), then Selection Criteria code (BT-809-Lot) and Selection Criteria Description 
(BT-750-Lot) are mandatory. Multiple codes and their associated description may be provided.

When the notice is not identified as a Source for Selection Criteria, then Selection Criteria code 
(BT-809-Lot) and Selection Criteria Description (BT-750-Lot) are forbidden.
...
is set to 'epo-Notice'), then Exclusion Ground code (BT-67(a)-Procedure) and Exclusion Ground Description 
(BT-67(b)-Procedure) are mandatory. Multiple codes and their associated description may be provided.
...
Exclusion Grounds (BT-67(a)-Procedure) refer to criteria that, not met and justified
...
"exclusion-ground" tailored from the https://op.europa.eu/web/eu-vocabularies/at-dataset/-/resource/dataset/criterion[criterion] codelist. 
...
<cac:TendererQualificationRequest>
    ...
    <cac:SpecificTendererRequirement>
        <cbc:TendererRequirementTypeCode listName="exclusion-grounds-source">proc-doc</cbc:TendererRequirementTypeCode>
    </cac:SpecificTendererRequirement>
    <cac:SpecificTendererRequirement>
        <cbc:TendererRequirementTypeCode listName="exclusion-grounds-source">notice</cbc:TendererRequirementTypeCode>
    </cac:SpecificTendererRequirement>
</cac:TendererQualificationRequest>
...
when the value is set to "_true_", Foreign Subsidies Measures (BT-682-Tender) may exist and shall be 
specified for any tender for that Lot subject to such measures.
