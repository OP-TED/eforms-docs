...
A sample mark-up is provided below for a case where the directive applies 
and procurement concerns "Power transformers" as well as "Water pumps" (the structure occurs in the extensions of the TenderingTerms of 
the given Lot):
...
This information is also possible at Lot level for Result notices.
