...
<<notices-xml-structure.adoc#reusedElementsFigure, Major reused components>>
...
[%hardbreaks]
<<documents-forms-and-notices.adoc#noticeTypesSubtypesTable, Notice types & subtypes>>
