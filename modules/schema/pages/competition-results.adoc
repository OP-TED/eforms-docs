...
the Ecodesign Directive, Union GPP criteria, Regulation 2020/740 or further provisions in Article 7 
...
Ecodesign Directive, Union GPP criteria ...)  
|*** a|
[source,xpath,subs=attributes]
----
...
|*Energy Efficiency Quantity (BT-815)* |Yearly energy savings in kWh for products, services, works and buildings.  
|*** a|
[source,xpath,subs=attributes]
----
