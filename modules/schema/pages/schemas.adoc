...
h|Pre-Market Consultation a|
* PMC
.2+a|PriorInformationNotice
...
h|Contract Completion Notice a|* Contract completion

h|Change Notice a|* _Any_ | _Any of the 3_
|===
