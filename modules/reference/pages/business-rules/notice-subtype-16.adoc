...
*Never allowed* in notice sub-type 16.
|`ERROR`
h|`BT-13(t)-Part`
a|
...
*Allowed if* the value chosen for BT-105-Procedure is 'Negotiated with prior publication of a call for competition / competitive with negotiation'.
...
*Mandatory if* Lots All Required (BT-763) is true or there is more than a Lot in the notice.

.Condition in EFX
[source, EFX]
----
BT-763-Procedure == 'All' or count(/BT-137-Lot) > 1
----
|`ERROR`
h|`BT-33-Procedure`
a|
