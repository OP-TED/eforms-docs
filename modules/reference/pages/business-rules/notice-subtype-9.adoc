...
*Never allowed* in notice sub-type 9.
|`ERROR`
h|`BT-09(b)-Procedure`
a|
...
*Allowed if* the value chosen for BT-65_Lot is equal to 'The contractor must subcontract a minimum percentage of the contract using the procedure set out in Title III of Directive 2009/81/EC.
...
*Allowed if* subcontracting Obligation (BT-65) is specified.

.Condition in EFX
[source, EFX]
----
BT-65-Lot is present
----
|`ERROR`
h|`BT-660-LotResult`
a|
