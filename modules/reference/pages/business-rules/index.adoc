...
[source, EFX]
----
(BT-106-Procedure == 'true') and (OPP-070-notice in ('16','29','E5')) and (BT-105-Procedure is present)
----
|`ERROR`
h|`BR-BT-00105-0111`
h|`BT-105-Procedure`
...
[source, EFX]
----
(BT-106-Procedure == 'true') and (OPP-070-notice in ('18','31','E5')) and (BT-105-Procedure is present)
----
|`ERROR`
h|`BR-BT-00105-0112`
h|`BT-105-Procedure`
...
[source, EFX]
----
(BT-106-Procedure == 'true') and (OPP-070-notice in ('17','30','E5')) and (BT-105-Procedure is present)
----
|`ERROR`
h|`BR-BT-01118-0100`
...
[source, EFX]
----
BT-02-notice in ('can-desg','can-social','can-standard','can-tran','cn-desg','cn-social','cn-standard','compl','corr','pin-buyer','pin-cfc-social','pin-cfc-standard','pin-only','pin-rtl','pin-tran','pmc','qu-sy','subco','veat')
----
|`ERROR`
h|`BR-BT-00738-0053`
h|`BT-738-notice`
