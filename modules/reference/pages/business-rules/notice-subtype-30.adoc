...
*Never allowed* in notice sub-type 30.
|`ERROR`
h|`BT-13(t)-Part`
a|
...
*Allowed if* Country Origin (BT-191-Tender) exists..

.Condition in EFX
[source, EFX]
----
BT-191-Tender is present
----
|`ERROR`
...
*Allowed if* Procedure Accelerated (BT-106-Procedure) exists..

.Condition in EFX
[source, EFX]
----
BT-106-Procedure is present
----
|`ERROR`
h|`BT-195(BT-1351)-Procedure`
a|

*Allowed if* Procedure Accelerated Justification (BT-1351-Procedure) exists..

.Condition in EFX
[source, EFX]
----
BT-1351-Procedure is present
----
|`ERROR`
...
*Allowed if* Unpublished Identifier (BT-195(BT-106)-Procedure) exists..

.Condition in EFX
[source, EFX]
----
BT-195(BT-106)-Procedure is present
----
|`ERROR`
...
*Allowed if* Unpublished Identifier (BT-195(BT-1351)-Procedure) exists..

.Condition in EFX
[source, EFX]
----
BT-195(BT-1351)-Procedure is present
----
|`ERROR`
...
*Allowed if* Unpublished Identifier (BT-195(BT-191)-Tender) exists..

.Condition in EFX
[source, EFX]
----
BT-195(BT-191)-Tender is present
----
|`ERROR`
...
*Allowed if* CVD Contract Type (BT-735-LotResult) exists.

.Condition in EFX
[source, EFX]
----
BT-735-LotResult is present
----
|`ERROR`
h|`BT-726-Part`
a|
...
*Allowed if* Clean Vehicles Directive (BT-717) is true for the given Lot, and the Lot has been awarded.

.Condition in EFX
[source, EFX]
----
(BT-13713-LotResult == BT-137-Lot[BT-717-Lot == 'true']) and (BT-142-LotResult == 'selec-w')
----
|`ERROR`
h|`BT-736-Part`
a|
...
*Allowed if* Vehicle Category (BT-723-LotResult) exists.

.Condition in EFX
[source, EFX]
----
BT-723-LotResult is present
----
|`ERROR`
h|`OPT-156-LotResult`
a|
