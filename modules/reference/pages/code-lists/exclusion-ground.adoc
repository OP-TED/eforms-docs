...
Structure:: flat
Used in:: xref:business-terms/BT-67(a).adoc[`BT-67(a)`] The criteria (or criterion) of the given type are (is) used, unused, or (in case of prior information notice used as a call for competition or to reduce time limits) the use is not yet known.
...
[horizontal]
  ...
  `exg-mis-misrepresent`::: Misrepresentation, withheld information, unable to provide required documents or obtained confidential information of this procedure
