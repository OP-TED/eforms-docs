...
Tailored by:: xref:code-lists/bri.adoc[`bri`], xref:code-lists/competition.adoc[`competition`], xref:code-lists/cont-modif.adoc[`cont-modif`], xref:code-lists/dir-awa-pre.adoc[`dir-awa-pre`], xref:code-lists/planning.adoc[`planning`], xref:code-lists/result.adoc[`result`]
Structure:: flat
