...
[horizontal]
Version:: 20241211-0
URI:: http://publications.europa.eu/resource/dataset/energy-efficiency-item
Structure:: flat
...
[horizontal]
  ...
  `products`::: Products
  `refri-appl`::: Refrigerating appliances with a direct sales function
  `ser-da-sto`::: Servers and data storage products
  `services`::: Services
  `spa-com-hea`::: Space and combination heaters
  `tum-dry`::: Tumble driers
  `tv-nat-law`::: TVs - electronic displays national law
  `tyres`::: Tyres
  `vac-clea`::: Vacuum cleaners
  `ventila`::: Ventilation units
  `wa-hea-tan`::: Water heaters - storage tanks and solar devices
  `wa-pu`::: Water pumps
