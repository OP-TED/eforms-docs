...
The following Business Terms are included in version {page-component-version}version} of eForms SDK.
...
|===
h| Identifier h| Description h| Data Type h| Details
h| `BT-722` | Contract EU Funds Name | `TEXT` a| xref:business-terms/BT-722.adoc[See fields]
...
h| `OPT-101` | Framework Notice Version | `-` a| xref:business-terms/OPT-101.adoc[See fields]
