...
|===
h| Identifier h| Description h| Data Type h| Details
h| `BT-67(a)` | The criteria (or criterion) of the given type are (is) used, unused, or (in case of prior information notice used as a call for competition or to reduce time limits) the use is not yet known. | `CODE` a| xref:business-terms/BT-67(a).adoc[See fields]
h| `BT-67(b)` | The brief description of the exclusion criteria (or criterion). | `TEXT` a| xref:business-terms/BT-67(b).adoc[See fields]
|===
[#BG-702]
