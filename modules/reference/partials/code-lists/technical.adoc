...
See xref:code-lists/compl.adoc[details & codes]
...
See xref:code-lists/completion.adoc[details & codes]
...
See xref:code-lists/consultation.adoc[details & codes]
...
See xref:code-lists/eed-scope.adoc[details & codes]
...
[horizontal]
Tailored by:: <<_accelerated_procedure,`accelerated-procedure`>>, <<_cvd_scope,`cvd-scope`>>, <<_eed_scope,`eed-scope`>>, <<_esignature_submission,`esignature-submission`>>, <<_fsr,`fsr`>>, <<_ipi_scope,`ipi-scope`>>, <<_nda,`nda`>>, <<_required,`required`>>, <<_subcontracting_allowed,`subcontracting-allowed`>>, <<_tender_guarantee_required,`tender-guarantee-required`>>
Version:: 1.0
...
See xref:code-lists/international-procurement-instrument-measure.adoc[details & codes]
...
See xref:code-lists/ipi-scope.adoc[details & codes]
...
See xref:code-lists/metric-type.adoc[details & codes]
...
See xref:code-lists/nuts-xkx-lvl3.adoc[details & codes]
...
See xref:code-lists/pmc.adoc[details & codes]
...
=== `procedure-type-15`
Allowed procedure type for notice subtype 15
[horizontal]
Subset of:: <<_procurement_procedure_type,`procurement-procedure-type`>>
Version:: 20220928-0

See xref:code-lists/procedure-type-15.adoc[details & codes]
