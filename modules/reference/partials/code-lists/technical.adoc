...
[horizontal]
Tailored by:: <<_accelerated_procedure,`accelerated-procedure`>>, <<_esignature_submission,`esignature-submission`>>, <<_required,`required`>>, <<_subcontracting_allowed,`subcontracting-allowed`>>, <<_tender_guarantee_required,`tender-guarantee-required`>>
Version:: 1.0
