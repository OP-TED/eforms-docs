...
See xref:code-lists/energy-efficiency-basis.adoc[details & codes]
...
See xref:code-lists/energy-efficiency-item.adoc[details & codes]
...
See xref:code-lists/energy-efficiency-label.adoc[details & codes]
...
See xref:code-lists/international-procurement-instrument-application.adoc[details & codes]
