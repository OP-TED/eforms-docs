...
`unpublishGroupId`:: Indicates the group which contains the unpublish fields. +
value: a text string (e.g. `"GR-Unpublish-BT-105-Procedure"`)

`unpublishFieldId`:: Indicates the id of the field carrying the identifier of the field to be unpublished. +
value: a text string (e.g. `"BT-195(BT-105)-Procedure"`)

`unpublishCode`:: Indicates the code used to identify the field to be unpublished. +
value: a text string (e.g. `"pro-typ"`)
