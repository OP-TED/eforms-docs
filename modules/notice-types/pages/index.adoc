...
value: a text string (e.g. `"BT-137-LotsGroup"`)

`unpublishGroupId`:: Indicates the group which contains the data about unpublishing this field.  +
value: a text string (e.g. `"GR-Unpublish-BT-105-Procedure"`)

`unpublishFieldId`:: Indicates the field id of the unpublished identifier.  +
value: a text string (e.g. `"BT-195(BT-105)-Procedure"`)

`unpublishCode`:: Indicates the privacy code.  +
