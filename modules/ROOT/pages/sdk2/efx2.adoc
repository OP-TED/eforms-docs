...
*Privacy controls:* Expressions can now access privacy-related properties of fields withheld from publication:
...
*Raw value access:* `field:rawValue` provides access to the raw string value of a field, bypassing type-specific parsing:
