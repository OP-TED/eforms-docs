...
The SDK roadmap is available at link:https://docs.ted.europa.eu/eforms-common/roadmap/index.html[eForms SDK roadmap] 
and is updated progressively. The page was created with a view to outlining the changes and additions to the eForms SDK 
