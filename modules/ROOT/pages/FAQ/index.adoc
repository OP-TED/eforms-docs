...
information for a given contract. A Contract Modification notice can only change one contract at a time 
and should only contain the information relevant to the modified contract, i.e. other contracts and lots 
not related to the modified contract, should not be included. 
+
...
or the latest change to a contract award notice. 
+
