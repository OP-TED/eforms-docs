...
+
Following the 2024 series, OP has announced the link:https://op.europa.eu/en/web/ted-eforms/home[TED eSender workshops schedule for 2025].
...
+
* eForms presentations from the https://op.europa.eu/en/web/ted-eforms/agenda-q3-25-september-2025[TED eSender Workshop in September 2025] +
