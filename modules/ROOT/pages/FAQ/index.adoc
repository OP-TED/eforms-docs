...
+
These optional forms will be implemented in 2024, as defined in the second amendment to the eForms implementing regulation. The new voluntary forms will be included in SDK release 1.13, scheduled to be released in mid-November 2024. 
+
...
What dates do search parameters "submittedAt", "createdAt", "updadedAt", "transmittedAt" and “expectedPublicationDate” represent?::
