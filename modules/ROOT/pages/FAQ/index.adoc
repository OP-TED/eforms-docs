...
It will be possible to continue to view your published notices in eNotices until 30 June 2024. eSentool remained available until 30 April 2024. 
+
The new eNotices2 application is an application that performs both functions carried out by eNotices and eSentool applications; 
...
+
OP has also developed an application to convert from TED XML to eForms XML using these XSLT files and which is provided as a public API service. 
+
