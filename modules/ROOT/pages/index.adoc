...
NOTE: The documentation is only available for xref:_@eforms-common::active-versions:index.adoc[active versions] of the eForms SDK. For the documentation on older SDK versions, you can visit the https://wayback.archive-it.org/12090/*/https:/docs.ted.europa.eu/[archived versions] of this website on the EU web archive.
