...
The EFX Toolkit for Java Developers, contains a generic translator that can be reused to translate EFX to several different target languages. See the xref:#create-your-own-translators[next section] for more details.
