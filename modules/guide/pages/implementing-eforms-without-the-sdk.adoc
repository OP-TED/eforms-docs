...
The best solution for validating notices would be to validate them through the xref:api:validate.adoc[TED Validation API]. 
...
== Visualising notices
For visualising notices you can use the xref:api:visualise.adoc[TED Visualisation API]. This will render the notice as HTML or PDF for you. 
...
+  
TIP: To minimize the impact of this type of change on your traditional application, use the xref:api:validate.adoc[TED Validation API] to validate notices.
...
+ 
TIP: To minimize the impact of this type of change on your traditional application, use the xref:api:visualise.adoc[TED Visualisation API] to visualise notices.
