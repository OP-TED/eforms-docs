...
The  validation message intended for display to your end-user is provided in the `svrl:text` element, in the language you indicated in your request. If the message is not available yet in this language, the identifier of label is given instead.
