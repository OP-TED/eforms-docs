...
==== Tips for eSenders
    ...
    * eNotices2 API supports currently SDK versions 1.3, 1.4, 1.5, 1.6 and 1.7. SDK version 1.7 is supported in Preview environment as of 15 May 2023. For the value to indicate in the cbc:CustomizationID element, it should always have the format "eforms-sdk-major.minor".  See this page for more details: 
...
SDK versions:: 1.0.0, 1.1.1, 1.2.1, 1.3.3, 1.4.2, 1.5.2, 1.6.0
