...
Due to an error in our internal systems, notices submitted to eNotices2 Preview as of 6 November 2023 do not get status Published; we are working to fix this as soon as possible.
...
SDK versions:: 1.0.0, 1.1.1, 1.2.1, 1.3.4, 1.4.3, 1.5.3, 1.6.1, 1.7.0, 1.8.0, 1.9.0
