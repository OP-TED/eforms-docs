...
The following issue has been identified as of SDK version 1.10:

* If you choose to withhold the publishing of certain fields in Results notices, please ensure that the "Date of when this will be published" (BT-198) is always filled. There is currently a bug which means that the field will be published on TED if you provide no date. There are also certain other "Published later" fields that may stop your notice from being published. We aim to solve these issues in February. 
...
SDK versions:: 1.0.0, 1.1.1, 1.2.1, 1.3.2, 1.4.2, 1.5.0, 1.5.1, 1.6.0, 1.7.0, 1.8.0, 1.9.0, 1.10.0
