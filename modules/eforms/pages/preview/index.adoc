...
==== Tips for eSenders
    ...
    * eNotices2 API supports currently SDK versions 1.3, 1.4, 1.5, 1.6 and 1.7. SDK version 1.7 is supported both in Preview and Production environments as of 15 May 2023. For the value to indicate in the cbc:CustomizationID element, it should always have the format "eforms-sdk-major.minor".  See this page for more details: 
