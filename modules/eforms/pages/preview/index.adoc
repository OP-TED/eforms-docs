...
For the applications with a web user interface (eNotices2 and TED API), users can sign in with an EU Login from the acceptance environment at  https://ecas.acceptance.ec.europa.eu/cas 
