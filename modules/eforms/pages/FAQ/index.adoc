...
publication field in the eForms notice. See link:https://docs.ted.europa.eu/eforms/1.2.1/schema/elements.html#previousNoticeSection[Previous Notice (OPP-090)]
...
+
See also link:https://docs.ted.europa.eu/eforms/1.2.1/schema/elements.html#previousNoticeSection[Previous Notice (OPP-090)]
in the documentation. 
...
+
See link:https://docs.ted.europa.eu/eforms/1.2.1/schema/change-notice.html#changesAssociatedElementsTable[Changes-associated elements] in the documentation
...
+
The Notice VersionID is described in the link:https://docs.ted.europa.eu/eforms/1.2.1/schema/elements.html#noticeIDSection[Notice & Version Identifiers] 
...
+ 
In the link:https://docs.ted.europa.eu/eforms/1.2.1/schema/change-notice.html[Change Notice] section, the word "version" is used 
...
link:https://docs.ted.europa.eu/eforms/1.2.1/schema/identifiers.html#_referring_to_sections_of_a_notice[Referring to sections of a notice]. 
...
will be published as a Change notice for a link:https://docs.ted.europa.eu/eforms/1.2.1/schema/contract-modification-notice.html[Contract Modification Notice].
...
We have a specific definition for link:https://docs.ted.europa.eu/eforms/1.2.1/fields/index.html#_what_is_a_field[Fields].
...
+
See link:https://docs.ted.europa.eu/eforms/1.2.1/schema/procedure-lot-part-information.html[Table 1. Numbering schemes for Parts, Lots and Group of Lots]
in the documentation.
...
see https://docs.ted.europa.eu/eforms/1.2.1/schema/parties.html#organizationSection. It has a single identifier, 
...
https://docs.ted.europa.eu/eforms/1.2.1/schema/parties.html#buyerSection. 
+
...
https://docs.ted.europa.eu/eforms/1.2.1/schema/parties.html#_legislation_information_provider 
and the following section: https://docs.ted.europa.eu/eforms/1.2.1/schema/parties.html#_other_rolessubroles  
+
These references use fields OPT-300 and OPT-301. These and other similar references are listed in: 
https://docs.ted.europa.eu/eforms/1.2.1/schema/identifiers.html 
...
link:https://docs.ted.europa.eu/eforms/1.2.1/schema/identifiers.html#_referring_to_objects[IDs & References].
+
...
(https://docs.ted.europa.eu/eforms/1.2.1/schema/competition-results.html#tenderingPartySection). A Tendering Party may contain one or more tenderers.
...
under the section https://docs.ted.europa.eu/eforms/1.2.1/schema/identifiers.html#pointlessDueToDesignSection["Pointless due to design"].
...
+
For more information, see https://docs.ted.europa.eu/eforms/1.2.1/codelists/index.html[Tailored Codelists] 
in the documentation.
