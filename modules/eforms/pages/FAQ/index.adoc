...
and building metadata-driven applications.
...
+
When you submit a notice, you can select a preferred publication date, or you can ask for publication “as soon as possible”. 
