...
+
A follow-up link:https://op.europa.eu/en/web/eforms-2022/home[second eForms Technical Workshop] took place online on 29 & 30 September 2022.
...
publication field in the eForms notice. See link:https://docs.ted.europa.eu/eforms/1.3.2/schema/elements.html#previousNoticeSection[Previous Notice (OPP-090)]
...
+
See also link:https://docs.ted.europa.eu/eforms/1.3.2/schema/elements.html#previousNoticeSection[Previous Notice (OPP-090)]
in the documentation. 
...
+
See link:https://docs.ted.europa.eu/eforms/1.3.2/schema/change-notice.html#changesAssociatedElementsTable[Changes-associated elements] in the documentation
...
+
The Notice VersionID is described in the link:https://docs.ted.europa.eu/eforms/1.3.2/schema/elements.html#noticeIDSection[Notice & Version Identifiers] 
...
+ 
In the link:https://docs.ted.europa.eu/eforms/1.3.2/schema/change-notice.html[Change Notice] section, the word "version" is used 
...
link:https://docs.ted.europa.eu/eforms/1.3.2/schema/identifiers.html#_referring_to_sections_of_a_notice[Referring to sections of a notice]. 
...
the notice will obtain the status “Not published”.
+
...
will be published as a Change notice for a link:https://docs.ted.europa.eu/eforms/1.3.2/schema/contract-modification-notice.html[Contract Modification Notice].
...
applications using the SDK, followed by the link:https://op.europa.eu/en/web/eforms-2022/agenda[second eForms Technical Workshop of September 2022]
+
...
and add several business terms. The amendment will not be published on EUR-Lex before December, however, the public consultation is available at:
+
https://ec.europa.eu/info/law/better-regulation/have-your-say/initiatives/13550-Public-procurement-eForms-amending-the-Implementing-Regulation-on-standard-forms-used-for-publication-of-notices_en
+
The BTs included in this version of the annex are the same ones that we have included in the SDK and that the amendment will have; 
...
will often come for legal reasons and will be given enough transition time. Technically, there would be no reason 
...
We have a specific definition for link:https://docs.ted.europa.eu/eforms/1.3.2/fields/index.html#_what_is_a_field[Fields].
...
+
See link:https://docs.ted.europa.eu/eforms/1.3.2/schema/procedure-lot-part-information.html[Table 1. Numbering schemes for Parts, Lots and Group of Lots]
in the documentation.
...
see https://docs.ted.europa.eu/eforms/1.3.2/schema/parties.html#organizationSection. It has a single identifier, 
...
https://docs.ted.europa.eu/eforms/1.3.2/schema/parties.html#buyerSection. 
+
...
https://docs.ted.europa.eu/eforms/1.3.2/schema/parties.html#_legislation_information_provider 
and the following section: https://docs.ted.europa.eu/eforms/1.3.2/schema/parties.html#_other_rolessubroles  
+
These references use fields OPT-300 and OPT-301. These and other similar references are listed in: 
https://docs.ted.europa.eu/eforms/1.3.2/schema/identifiers.html 
...
link:https://docs.ted.europa.eu/eforms/1.3.2/schema/identifiers.html#_referring_to_objects[IDs & References].
+
...
(https://docs.ted.europa.eu/eforms/1.3.2/schema/competition-results.html#tenderingPartySection). A Tendering Party may contain one or more tenderers.
...
under the section https://docs.ted.europa.eu/eforms/1.3.2/schema/identifiers.html#pointlessDueToDesignSection["Pointless due to design"].
...
When we look at the eForms PIN only notices (4-5-6), they allow to indicate whether a Framework Agreement will be used (BT-765), but not whether a Dynamic Purchasing System will be used (BT-766). Shouldn’t both BTs either be allowed or not allowed for forms 4-5-6?::

The following changes will be included in the upcoming Amendment to the Regulation: DPS will be added for PIN only notices, 
aligned with Framework Agreement BT-765. DPS will also be added for D81 forms, in case Member States do use them.  
...
Please note that BTs relating to clean vehicles are due to be changed in the amendment to the 2019 eForms implementing regulation 
that the European Commission is planning to publish. Therefore, the BTs and their related codelists may also change, 
but no later than November 2022 when eForms come into effect. Any changes will first be reflected in the SDK shortly before November 2022 
followed by their required codelists changes. 
...
+
For more information, see https://docs.ted.europa.eu/eforms/1.3.2/codelists/index.html[Tailored Codelists] 
in the documentation.
