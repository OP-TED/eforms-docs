...
An initial version of the SDK roadmap is available at https://docs.ted.europa.eu/home/eforms/roadmap/index.html[eForms SDK roadmap] 
...
that can also be useful to external parties. The eForms implementing regulation does not define many maximum length constraints 
...
We have a specific definition for https://docs.ted.europa.eu/eforms/0.5.0/fields/index.html#_what_is_a_field[Fields].
...
A “Preview” environment will be made available during Q2 2022, which will be 
announced through the usual channels. We plan to offer the possibility for users to go through 
all the steps from submission to publication, but this will be done incrementally, gradually adding steps to the environment. 
...
+
BT-52 belongs to a Business Group (BG-709 Second Stage) which is CM (Conditional Mandatory) and may not always exist; 
