...
+
The Notice VersionID is described in the link:https://docs.ted.europa.eu/eforms/1.1.1/schema/elements.html#noticeIDSection[Notice & Version Identifiers] 
...
+ 
In the link:https://docs.ted.europa.eu/eforms/1.1.1/schema/change-notice.html[Change Notice] section, the word "version" is used 
...
link:https://docs.ted.europa.eu/eforms/1.1.1/schema/identifiers.html#_referring_to_sections_of_a_notice[Referring to sections of a notice]. 
...
We have a specific definition for link:https://docs.ted.europa.eu/eforms/1.1.1/fields/index.html#_what_is_a_field[Fields].
...
see https://docs.ted.europa.eu/eforms/1.1.1/schema/parties.html#organizationSection. It has a single identifier, 
...
https://docs.ted.europa.eu/eforms/1.1.1/schema/parties.html#buyerSection. 
+
...
https://docs.ted.europa.eu/eforms/1.1.1/schema/parties.html#_legislation_information_provider 
and the following section: https://docs.ted.europa.eu/eforms/1.1.1/schema/parties.html#_other_rolessubroles  
+
These references use fields OPT-300 and OPT-301. These and other similar references are listed in: 
https://docs.ted.europa.eu/eforms/1.1.1/schema/identifiers.html 
...
link:https://docs.ted.europa.eu/eforms/1.1.1/schema/identifiers.html#_referring_to_objects[IDs & References].
+
...
(https://docs.ted.europa.eu/eforms/1.1.1/schema/competition-results.html#tenderingPartySection). A Tendering Party may contain one or more tenderers.
...
under the section https://docs.ted.europa.eu/eforms/1.1.1/schema/identifiers.html#pointlessDueToDesignSection["Pointless due to design"].
...
+
For more information, see https://docs.ted.europa.eu/eforms/1.1.1/codelists/index.html[Tailored Codelists] 
