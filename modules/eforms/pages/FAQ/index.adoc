...
+
* Identification of the notice that announced the Framwork Contract used for the current contract with Framework Notice Identifier (OPT-100).
+
* Identification of the previous notice which wa a TEDXML and does not therefore contain a Procedure ID using Previous Notice (OPP-090). 
