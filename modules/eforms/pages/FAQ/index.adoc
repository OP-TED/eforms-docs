...
Users can check all active versions of the SDK at any given time via the CVS API and version-range. See link:https://cvs.ted.europa.eu/swagger-ui/index.html[Swagger]. 
+
