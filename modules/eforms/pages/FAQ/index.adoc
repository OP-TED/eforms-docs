...
+
You can now register for the link:https://op.europa.eu/en/web/ted-eforms/registration[3rd eForms technical workshop] 
which will take place on 1 February 2023 at 10:00 CET. Past eForms events can also be found under "Previous editions" tab.
...
in the user interface and when querying the API with status “validation failed”. The same notice businessID (noticeID + versionID) cannot be reused. 
